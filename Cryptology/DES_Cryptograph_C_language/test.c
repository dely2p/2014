...
|                                                                             |
|                                                                             |
|      Data Standard Encryption (DES) encrypting & decrypting program         |
|                                                                             |
|                                                                             |
|                    Electric & Electronic Engineering College, Yonsei Univ.  |
|                                                                             |
|                                                      Yang, Jaehoon          |
|                                                                             |
|                                                                             |
|                                    if you want improve or fix this program  |
|                                         please contact me with this e-mail  |
|                                               yang@yonsei.ac.kr             |
|                                                                             |
|                                                                             |
-----------------------------------------------------------------------------/*/
...
int crn=0;     //current round number
int key[16][48];
...
/*/
    printf("Keyis:");
    for(i=0;i<48;i++)printf("%d",rkey[i]);
    printf("\n");/*/
    for(i=0;i<48;i++)rtmp[i]=r[expand[i]-1];
    /*/printf("R  is:");
    for(i=0;i<48;i++)printf("%d",rtmp[i]);
    printf("\n");
    printf("XORis:");/*/
    for(i=0;i<48;i++){
    ...
    for(i=0;i<8;i++){
        stmp[i]=S[i][2*rtmp[6*i]+rtmp[5+6*i]][8*rtmp[1+6*i]+4*rtmp[2+6*i]+2*rtmp[3+6*i]+rtmp[4+6*i]];
...
int* encrypt(int plain[64], int round)
{
    ...
    for(i=0;i<round;i++)
    {
        ...
        //printf("L%d : ",i);
        //for(k=0;k<32;k++)printf("%d",l[k]);
        //printf("\n");
        //printf("R%d : ",i);
        //for(k=0;k<32;k++)printf("%d",r[k]);
        //printf("\n");
    }
...
void main()
{
    ...
    for(i=0;i<64;i++)printf("%d",plaintext[i]);
    printf("\n");    
    tube=encrypt(plaintext,16);
    for(i=0;i<64;i++)printf("%d",tube[i]);
    printf("\n");
